...
"C:\Program Files\7-Zip\7z" a -xr!.git quickFiltersWeb.zip manifest.json _locales scripts chrome popup html qFi-background.* *.txt release-notes.*
echo %quickFiltersWebRev% > revision.txt
move quickFilters*.xpi E:\Dev\Mozilla\Dev\quickFilters\_Test\6.13\
powershell -Command "Start-Sleep -m 50"
rename quickFiltersWeb.zip quickFilters-6.13.2pre%quickFiltersWebRev%.xpi
