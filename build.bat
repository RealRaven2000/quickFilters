...
"C:\Program Files\7-Zip\7z" a -xr!.svn quickFiltersWeb.zip manifest.json _locales scripts chrome popup qFi-background.* license.txt revision.txt release-notes.html`
echo %quickFiltersWebRev% > revision.txt
move quickFilters*.xpi E:\Dev\Mozilla\Dev\quickFilters\_Test\6.1.1\
powershell -Command "Start-Sleep -m 50"
rename quickFiltersWeb.zip quickFilters-wx-6.1.1pre%quickFiltersWebRev%.xpi